...
ud.profile_pic.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/default_profile_pic copy.png"), filename: "default_profile_pic.png")
...
p18.tags = [t4]
p18.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/running5.jpg"), filename: "running5.jpg")
...
Post.create!({ user_id: u4.id, title: 'Life is...', body: b1 })
p2.tags = [t1]
p2.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/food2.jpg"), filename: "food2.jpg")

p3 = Post.create!({ user_id: u3.id })
p3.tags = [t1]
p3.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/food3.jpg"), filename: "food3.jpg")
Post.create!({ user_id: u5.id, title: 'Life is...', body: b2 })

p11 = Post.create!({ user_id: u1.id })
p11.tags = [t9]
p11.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/cafe3.jpg"), filename: "cafe3.jpg")
Post.create!({ user_id: u3.id, title: 'Life is...', body: b3 })

p25 = Post.create!({ user_id: u5.id })
p25.tags = [t3]
p25.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/trail2.jpg"), filename: "trail2.jpg")

# ==================================
p1 = Post.create!({ user_id: u1.id })
p1.tags = [t1]
p1.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/food1.jpg"), filename: "food1.jpg")
Post.create!({ user_id: u5.id, title: 'Life is...', body: b2 })

p6 = Post.create!({ user_id: u1.id })
p6.tags = [t8]
p6.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/books1.jpg"), filename: "books1.jpg")
Post.create!({ user_id: u5.id, title: 'Life is...', body: b2 })

p5 = Post.create!({ user_id: u5.id })
p5.tags = [t2]
p5.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/anime1.gif"), filename: "anime1.gif")
Post.create!({ user_id: u1.id, title: 'Life is...', body: b1 })

p7 = Post.create!({ user_id: u2.id })
Post.create!({ user_id: u3.id, title: 'Life is...', body: b3 })
p7.tags = [t8]
p7.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/books2.jpg"), filename: "books2.jpg")

p8 = Post.create!({ user_id: u3.id })
p8.tags = [t9]
p8.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/cafe1.jpg"), filename: "cafe1.jpg")
Post.create!({ user_id: u3.id, title: 'Life is...', body: b3 })

p10 = Post.create!({ user_id: u5.id })
p10.tags = [t2]
p10.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/anime2.gif"), filename: "anime2.gif")
Post.create!({ user_id: u1.id, title: 'Life is...', body: b1 })
...
p17.tags = [t6]
p17.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/music4.jpg"), filename: "music4.jpg")
Post.create!({ user_id: u4.id, title: 'Life is...', body: b1 })

p12 = Post.create!({ user_id: u2.id })
p12.tags = [t9]
p12.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/cafe4.jpg"), filename: "cafe4.jpg")
Post.create!({ user_id: u4.id, title: 'Life is...', body: b1 })

p4 = Post.create!({ user_id: u4.id })
p4.tags = [t1]
p4.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/food4.jpg"), filename: "food4.jpg")

p13 = Post.create!({ user_id: u3.id })
p13.tags = [t6]
Post.create!({ user_id: u2.id, title: 'Life is...', body: b2 })
p13.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/music1.jpg"), filename: "music1.jpg")
Post.create!({ user_id: u3.id, title: 'Life is...', body: b3 })

p14 = Post.create!({ user_id: u4.id })
p14.tags = [t6]
p14.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/music2.jpg"), filename: "music2.jpg")

p15 = Post.create!({ user_id: u5.id })
Post.create!({ user_id: u2.id, title: 'Life is...', body: b2 })
p15.tags = [t5]
p15.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/gaming1.gif"), filename: "gaming1.gif")

# ==================================

p16 = Post.create!({ user_id: u1.id })
p16.tags = [t6]
p16.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/music3.jpg"), filename: "music3.jpg")
Post.create!({ user_id: u5.id, title: 'Life is...', body: b2 })

p18 = Post.create!({ user_id: u3.id })
p18.tags = [t4]
Post.create!({ user_id: u1.id, title: 'Life is...', body: b1 })
p18.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/running1.jpg"), filename: "running1.jpg")
Post.create!({ user_id: u3.id, title: 'Life is...', body: b3 })

p9 = Post.create!({ user_id: u4.id })
p9.tags = [t9]
p9.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/cafe2.jpg"), filename: "cafe2.jpg")
Post.create!({ user_id: u2.id, title: 'Life is...', body: b2 })

p19 = Post.create!({ user_id: u4.id })
p19.tags = [t4]
p19.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/running2.jpg"), filename: "running2.jpg")
Post.create!({ user_id: u2.id, title: 'Life is...', body: b2 })

p20 = Post.create!({ user_id: u5.id })
p20.tags = [t5]
p20.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/gaming2.gif"), filename: "gaming2.gif")
Post.create!({ user_id: u1.id, title: 'Life is...', body: b1 })
...
p16 = Post.create!({ user_id: u1.id })
p16.tags = [t4]
p16.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/running3.jpg"), filename: "running3.jpg")
Post.create!({ user_id: u5.id, title: 'Life is...', body: b2 })

p17 = Post.create!({ user_id: u2.id })
p17.tags = [t4]
p17.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/running4.jpg"), filename: "running4.jpg")
Post.create!({ user_id: u4.id, title: 'Life is...', body: b1 })
Post.create!({ user_id: u5.id, title: 'Life is...', body: b2 })

p23 = Post.create!({ user_id: u3.id })
p23.tags = [t3]
p23.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/trail5.jpg"), filename: "trail5.jpg")

p19 = Post.create!({ user_id: u4.id })
p19.tags = [t3]
p19.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/trail1.jpg"), filename: "trail1.jpg")
Post.create!({ user_id: u2.id, title: 'Life is...', body: b2 })

p20 = Post.create!({ user_id: u5.id })
p20.tags = [t3]
p20.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/trail2.jpg"), filename: "trail2.jpg")
Post.create!({ user_id: u1.id, title: 'Life is...', body: b1 })
...
Post.create!({ user_id: u3.id, title: 'Life is...', body: b3 })
p21.tags = [t3]
p21.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/trail3.jpg"), filename: "trail3.jpg")

p22 = Post.create!({ user_id: u2.id })
p22.tags = [t3]
p22.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/trail4.jpg"), filename: "trail4.jpg")
Post.create!({ user_id: u4.id, title: 'Life is...', body: b1 })

p24 = Post.create!({ user_id: u4.id })
p24.tags = [t3]
p24.media.attach(io: File.open("/Users/Cashiola/Desktop/stellar_seeds/trail1.jpg"), filename: "trail1.jpg")
Post.create!({ user_id: u2.id, title: 'Life is...', body: b2 })
